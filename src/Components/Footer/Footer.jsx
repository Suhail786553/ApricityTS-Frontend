    ...
    <div className="text-white py-12" style={{backgroundColor:"#0f0a14"}}>
      <div className="flex flex-col md:flex-row justify-between items-start max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 md:mb-0">
          ...
          <p className="mb-4">Businesses with smart AI-driven solutions in UAE, Dubai.</p>
          <div className="flex space-x-4 mb-4">
            {/* Social Media Icons */}
            <a href="#" className="text-white-800 text-2xl hover:text-white-500">
                <FaFacebook />
              </a>
              <a href="#" className="text-white-800 text-2xl hover:text-white-500">
                <FaInstagram />
        ...
        <div className="md:ml-auto w-full md:w-auto">
          ...
          <div className="mb-4 flex flex-col space-y-4">
            ...
            />
            <button
              className="bg-[#904af2] text-white p-3 rounded-md"
            >
