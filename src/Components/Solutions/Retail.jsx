                        ...
                        <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-8 px-6">
                            ...
                            <div className="text-white flex flex-col justify-center">
                                ...
                                <p className="text-lg mb-4">
                                    ...
                                    Rapidly capture and process large quantities of financial data with precision
                                </p>
                                <p className="text-lg font-bold mb-6">Rapidly capture and process large quantities of financial data with precision</p>
                        ...
                        <div className="max-w-7xl mx-auto px-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 text-center">
                                <div className="bg-white p-6 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300">
                                    ...
                                    <h3 className="text-xl font-semibold text-[#243A55] mb-4">OCR-powered Document Understanding</h3>
                                    <p className="text-gray-600">
                                        Automate the extraction and understanding of data from scanned documents. Rapidly identify key information like names, dates, and clauses for efficient processing.
                                    </p>
                                </div>
                                ...
                                <div className="bg-white p-6 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300">
                                    ...
                                    <h3 className="text-xl font-semibold text-[#243A55] mb-4">Advanced OCR Search</h3>
                                    <p className="text-gray-600">
                                        Use our advanced search algorithms to locate critical information in digitized files instantly. Optimize accuracy and access with ApricityTS OCR technologies.
                                    </p>
                                </div>
                                ...
                                <div className="bg-white p-6 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300">
                                    ...
                                    <p className="text-gray-600">
                                        Leverage our OCR-driven solutions to handle bulk document processing. Validate and organize contracts and agreements with ease.
                                    </p>
                                </div>
                                ...
                                <div className="bg-white p-6 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300">
                                    ...
                                    <p className="text-gray-600">
                                        Automate compliance checks with ApricityTS’s OCR tools, identifying potential risks in legal documents such as non-compliance or unfavorable clauses.
                                    </p>
                                </div>
