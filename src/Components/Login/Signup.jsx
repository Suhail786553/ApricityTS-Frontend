...
const SignUpForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:5000/api/auth/signup","https://ocr-new.netlify.app/auth/signup",{ name, email, password });
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      : "https://ocr-new.netlify.app/api/auth/sendOtp";
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      :"https://ocr-new.netlify.app/auth/verifyOtp"
